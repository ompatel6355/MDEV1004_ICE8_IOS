...
class MovieViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
    ...
    func fetchMovies(completion: @escaping ([Movie]?, Error?) -> Void)
    {
        ...
        //guard let url = URL(string: "https://localhost:3000/api/movie/list") else
        {
            print("URL Error")
    ...
    func deleteMovie(at indexPath: IndexPath)
        {
            ...
            guard let url = URL(string: "https://mdev1004-ice-api.onrender.com/api/movie/delete/\(movie._id)") else {
                print("Invalid URL")
                return
            }
